...
namespace OverlayRW
{
	public partial class OverlayRWForm : Form
	{
		...
		private void ButtonDraw1RW_Click(object sender, EventArgs e)
		{
			...
			for (int i = 0; i < pictureBox1RW.Width - 1; i++)
			{
				...
				if (checkBoxDam1RW.Checked)
				{
					...
					if (i != 0) g.DrawLine(pen: p, x1: pictureBox1RW.Left + i - 1, y1: pictureBox1RW.Top + evelation1RW[i - 1], x2: pictureBox1RW.Left + i, y2: pictureBox1RW.Top + evelation1RW[i]);
				}
		...
		private void ButtonDraw2RW_Click(object sender, EventArgs e)
		{
			...
			g = CreateGraphics();
			b.Color = Color.White;
			g.FillRectangle(b, x: pictureBox2RW.Left, y: pictureBox2RW.Top, width: pictureBox2RW.Width, height: pictureBox2RW.Height);
			p.Color = Color.Black;
			g.DrawRectangle(p, x: pictureBox2RW.Left, y: pictureBox2RW.Top, width: pictureBox2RW.Width, height: pictureBox2RW.Height);
			...
			for (int i = 0; i < pictureBox2RW.Width - 1; i++)
			{
				switch (r.Next(minValue: 0, maxValue: 3))
				{
					...
					case 1: evelationOverlay[i] = evelationOverlay[i] + (int)numericUpDown2RW.Value; ; height += (int)numericUpDown2RW.Value; break;
					case 2: evelationOverlay[i] = evelationOverlay[i] - (int)numericUpDown2RW.Value; ; height -= (int)numericUpDown2RW.Value; break;
				}
				...
				{
					if (i != 0) g.DrawLine(pen: p, x1: pictureBox2RW.Left + i - 1, y1: pictureBox2RW.Top + evelation2RW[i - 1], x2: pictureBox2RW.Left + i, y2: pictureBox2RW.Top + evelation2RW[i]);
				}
				else
				{
					p.Color = Color.Red;
		...
		private void ButtonDraw3RW_Click(object sender, EventArgs e)
		{
			...
			for (int i = 0; i < pictureBox3RW.Width - 1; i++)
			{
				...
				{
					case 0: default: break;
					case 1: evelationOverlay[i] = evelationOverlay[i] + (int)numericUpDown3RW.Value; height += (int)numericUpDown3RW.Value; break;
					case 2: evelationOverlay[i] = evelationOverlay[i] - (int)numericUpDown3RW.Value; height -= (int)numericUpDown3RW.Value; break;
				}
				...
				if (checkBoxDam3RW.Checked)
				{
					...
					if (i != 0) g.DrawLine(pen: p, x1: pictureBox3RW.Left + i - 1, y1: pictureBox3RW.Top + evelation3RW[i - 1], x2: pictureBox3RW.Left + i, y2: pictureBox3RW.Top + evelation3RW[i]);
				}
		...
		private void ButtonDraw4RW_Click(object sender, EventArgs e)
		{
			...
			for (int i = 0; i < pictureBox4RW.Width - 1; i++)
			{
				...
				{
					case 0: default: break;
					case 1: evelationOverlay[i] = evelationOverlay[i] + (int)numericUpDown4RW.Value; height += (int)numericUpDown4RW.Value; break;
					case 2: evelationOverlay[i] = evelationOverlay[i] - (int)numericUpDown4RW.Value; height -= (int)numericUpDown4RW.Value; break;
				}
				...
				if (checkBoxDam4RW.Checked)
				{
					...
					if (i != 0) g.DrawLine(pen: p, x1: pictureBox4RW.Left + i - 1, y1: pictureBox4RW.Top + evelation4RW[i - 1], x2: pictureBox4RW.Left + i, y2: pictureBox4RW.Top + evelation4RW[i]);
				}
		...
		private void ButtonDrawOverlay_Click(object sender, EventArgs e)
		{
			...
			for (int i = 0; i < pictureBoxOverlay.Width - 1; i++)
			{
				...
				{
					if (i != 0) g.DrawLine(pen: p, x1: pictureBoxOverlay.Left + i - 1, y1: pictureBoxOverlay.Top + evelationOverlay[i - 1], x2: pictureBoxOverlay.Left + i, y2: pictureBoxOverlay.Top + evelationOverlay[i]);
				}
				else
				{
					p.Color = Color.Red;
